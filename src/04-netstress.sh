...
# ------------------------------------------------------------------------
# Iterations per message size, calibrated so each run takes ~xxxx minutes,
# based on the bandwidth actually measured at that size
# ------------------------------------------------------------------------
...
# ------ ~ 5 min per run ----
declare -A IB_ITERS=(
  [512]=24419000   [1024]=21970500  [2048]=14779000  [4096]=10013500
  [8192]=5902300   [16384]=3146750  [32768]=1650450  [65536]=842450
  [131072]=426450  [262144]=216485  [524288]=108165  [1048576]=54035
  [2097152]=27060  [4194304]=13540
)
declare -A ETH_ITERS=(
  [512]=1496500    [1024]=1373250   [2048]=1285600   [4096]=1037650
  [8192]=717250    [16384]=444400   [32768]=232075   [65536]=114470
  [131072]=73875   [262144]=50030   [524288]=25795   [1048576]=13020
  [2097152]=6530   [4194304]=3275
)
...
# NOTE --> 15 sizes, [10.5/5.5] min per size, 6 config
#         = 15.75 hours per iteration (10 min per run)
#         = 8.25 hours per iteration  (5 min per run)
